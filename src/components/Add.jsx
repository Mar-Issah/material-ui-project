...
//on click of the tooltip btn it is set open to true
      ...
      >
        ...
        >
          ...
          <UserContainer onClick={() => setOpen(true)}>
            <Avatar
              alt="myavatar"
              src="https://res.cloudinary.com/dytnpjxrd/image/upload/v1647815673/MERN%20Ecommerce/winter_red_jacket.webp"
